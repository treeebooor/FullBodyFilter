...
from fullbody_filter import good_image
...
try:
    ...
    #params["net_resolution_dynamic"]= 0
    ...
    imageToProcess = cv2.imread('nba.jpeg')
    ...
    cv2.imwrite("testNba.jpg", datum.cvOutputData)
    ...
    #cv2.waitKey(0)
     ...
     #   print("good image")
    #cv2.imwrite("test_58.jpg",datum.cvOutputData)
